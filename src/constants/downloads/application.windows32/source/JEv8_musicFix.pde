...
float dotSpeed = 0.8; //Loading dot move speed
float angle = 0; //Rotation variable for 
float angleSpeed = 0.03; //Angle rotation speed

float angle1 = 0;//Leg1 angle
float angle2 = 0;//Leg2 angle
float rotateSpeed = .03;//Leg movement speed
float walkX = -(bodyX+bodyWidth/2);
float walkY = 0;
float walkSpeed = .5; //Jeje's Walk Speed
...
void playMusic() { //Play music upon click
  //player.loop();
}

void stopMusic() { //Play music upon click
  //player.pause();
